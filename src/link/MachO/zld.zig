...
pub const Zld = struct {
    ...
    fn filterDataInCode(
        ...
        // TODO this might be too strong an assumption that the data comes presorted.
        // Perhaps it would be safer to parse and sort to ensure this is always the case.
